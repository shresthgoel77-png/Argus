...
class PullRequestAnalyzer(BaseAnalyzer):
    ...
    async def scan_repository_for_stale_prs(self, db: Session, repository: Repository, client: GitHubAppClient) -> None:
        ...
        for pr in prs:
            ...
            if now - updated_at > threshold:
                ...
                description = f"Pull Request #{pr_number} has been stale for over {settings.stale_pr_days} days."
