...
frontendEnvironment.NEXT_PUBLIC_API_URL = "http://localhost:8000";
...
export default defineConfig({
    ...
    webServer: [
        {
            command: "python -m alembic upgrade head && python -m uvicorn app.main:app --host 127.0.0.1 --port 8000",
            cwd: "../backend",
