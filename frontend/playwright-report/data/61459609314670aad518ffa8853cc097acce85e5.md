...
- Name: tests\auth-protected-routes.spec.ts >> Authentication and Protected Routes >> unauthenticated user is redirected to /login when accessing protected route
- Location: e2e\tests\auth-protected-routes.spec.ts:6:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/overview
Call log:
  - navigating to "http://localhost:3000/overview", waiting until "load"
