...
- Name: tests\auth-protected-routes.spec.ts >> Authentication and Protected Routes >> programmatic login allows access to protected routes
- Location: e2e\tests\auth-protected-routes.spec.ts:14:9
